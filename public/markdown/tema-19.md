...
### D. Artículo 46 — Planes de Igualdad en la Administración General del Estado
*   **Ámbito:** El Gobierno aprobará, al inicio de cada legislatura, un **Plan para la Igualdad entre Mujeres y Hombres en la Administración General del Estado y en los organismos públicos** vinculados o dependientes de ella.
*   **Contenido mínimo del Plan:** Objetivos a alcanzar, medidas a adoptar con perspectiva de género y plazos de ejecución de las mismas.
*   **Aplicación extensiva:** Este mandato se aplica analógicamente a las Universidades Públicas, que deben elaborar sus propios Planes de Igualdad (como el **III Plan de Igualdad de la Universidad de Sevilla 2024-2028**) siguiendo los mismos principios.
*   **Negociación:** Los planes de igualdad de las AAPP deben ser objeto de negociación, y en su caso acuerdo, con la representación legal de los empleados públicos (organizaciones sindicales).

### E. Artículo 77 — Unidades de Igualdad en las Universidades
*   **Mandato:** Las Universidades contarán entre sus estructuras de organización con **unidades de igualdad** para el desarrollo de las funciones relacionadas con el principio de igualdad entre mujeres y hombres.
*   **Funciones principales de estas unidades:**
    *   Asesorar a los órganos de gobierno en materia de igualdad.
    *   Elaborar y hacer seguimiento del Plan de Igualdad de la universidad.
    *   Velar por el cumplimiento del principio de igualdad de oportunidades en el acceso, la carrera académica y la representación de mujeres y hombres en los órganos de gobierno.
    *   Desarrollar formación y sensibilización en materia de igualdad para toda la comunidad universitaria.
*   **En la US:** Esta función la desempeña la **Unidad para la Igualdad de la Universidad de Sevilla**, adscrita al Vicerrectorado con competencias en igualdad. Es el órgano técnico que coordina el III Plan de Igualdad 2024-2028 y gestiona el protocolo contra el acoso (Tema 20).

> [!IMPORTANT]
> **Art. 46 vs Art. 77:** El Art. 46 obliga a los Gobiernos/AAPP a tener un **Plan de Igualdad** general. El Art. 77 obliga específicamente a las **universidades** a tener una **Unidad de Igualdad** permanente que gestione la aplicación de ese principio.
...
*   **Inversión de la carga de la prueba (Art. 13):** Corresponde a la parte demandada justificarse. **No aplica en procesos penales**.
...
*   **Art. 46 — Planes de Igualdad AGE:** El Gobierno aprueba al inicio de cada legislatura un Plan de Igualdad para toda la Administración General del Estado. Las universidades hacen lo propio.
*   **Art. 77 — Unidades de Igualdad en Universidades:** Obligatoriamente deben existir en toda universidad. En la US la Unidad de Igualdad está adscrita al Vicerrectorado de Igualdad.
*   **Órgano Evaluador US:** Unidad de Igualdad (Art. 77 LO 3/2007).
...
*   **Art. 46 y 77 — "El Plan y la Unidad":**
    *   Art. **46** → El **Plan** de Igualdad (para la AGE, extensivo a universidades).
    *   Art. **77** → La **Unidad** de Igualdad (en cada universidad).
...
*   **Plan de Igualdad (Art. 46 LO 3/2007):** Documento estratégico que los poderes públicos deben aprobar al inicio de cada legislatura con objetivos, medidas y plazos para la igualdad efectiva en las AAPP. En la US: III Plan de Igualdad 2024-2028.
*   **Unidad de Igualdad (Art. 77 LO 3/2007):** Estructura organizativa obligatoria en todas las universidades, responsable de asesorar en igualdad, desarrollar el Plan de Igualdad y velar por la paridad en los órganos de gobierno.
