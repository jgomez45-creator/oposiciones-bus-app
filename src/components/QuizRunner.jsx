            ...
            <div className="print-manual-index printable-exam-sheet" style={{ padding: '20px 0', fontFamily: "'Inter', sans-serif", margin: '0 auto', maxWidth: '820px', pageBreakBefore: 'always', breakBefore: 'page' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {compiledExamsContent.map(examBlock => (
                  <div key={examBlock.examNum} style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px dashed #ccc', padding: '6px 0', fontSize: '14pt', lineHeight: '1.4' }}>
            ...
            <div className="print-manual-index printable-exam-sheet" style={{ padding: '20px 0', fontFamily: "'Inter', sans-serif", margin: '0 auto', maxWidth: '820px', pageBreakBefore: 'always', breakBefore: 'page' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
                {testBookContent.map(block => (
                  <div key={block.topicId} style={{ display: 'flex', justifyContent: 'space-between', borderBottom: '1px dashed #ccc', padding: '6px 0', fontSize: '14pt', lineHeight: '1.4' }}>
